...
<h1 class="hello">ユーザー新規登録</h1>
	...
	<input type="text" name="loginId" class="botan1" value="${loginId}">
	</div>
	...
	<input type="text" name="name" class="botan4" value="${name}">
	</div>

	<div class="seinengappi">
	<p class="seinen">生年月日</p>
	<input type="date" name="birthDate" class="botan5" value="${birthDate}">
	</div>
